...
export type SaveFormat = 'txt' | 'pdf' | 'docx';
...
const SaveRubricModal: React.FC<SaveRubricModalProps> = ({
  isOpen,
  onClose,
  onSave,
  rubricTitle,
  ...
  const [selectedFormat, setSelectedFormat] = useState<SaveFormat>('txt');
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="p-4 space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Choose a format to save "<strong>{rubricTitle}</strong>" to your local machine
          </p>
