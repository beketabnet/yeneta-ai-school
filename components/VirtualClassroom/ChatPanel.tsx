...
interface ChatPanelProps {
  ...
  getWhiteboardState: () => Promise<{ json: any; image: string } | null>;
  useRag?: boolean;
...
const ChatPanel: React.FC<ChatPanelProps> = ({ messages, setMessages, lessonContext, onRaiseHand, onSuggestionAction, onAiToolCall, getWhiteboardState, useRag = true, useWebSearch = false }) => {
  ...
  const handleSend = async () => {
    ...
    const aiResponse = await getChatResponse(input, lessonContext, chatImageData, whiteboardState?.json, whiteboardState?.image, useRag, useWebSearch);
