            ...
            >
                <div className="container mx-auto px-6 flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        ...
                        <button
                            ...
                            className="bg-primary hover:bg-primary-dark text-white px-6 py-2.5 rounded-full font-bold shadow-lg shadow-primary/30 hover:shadow-primary/50 transform hover:-translate-y-0.5 transition-all duration-200"
                        >
                            Start for free
                        </button>
                        <button
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden absolute top-full left-0 right-0 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800 shadow-xl p-4 flex flex-col space-y-4 animate-fadeIn">
                        ...
                        <button onClick={() => { setView('signup'); setIsMobileMenuOpen(false); }} className="bg-primary text-white py-3 rounded-lg font-bold text-center shadow-md">Start for free</button>
                    </div>
                )}
            </header>
            ...
            <main>
                ...
                <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-gray-900 dark:text-white leading-[1.1] tracking-tight mb-8 max-w-5xl mx-auto">
                        ...
                        <p className="md:text-xl text-gray-600 dark:text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-200">
                            <button
                                onClick={() => setView('signup')}
                                className="w-full sm:w-auto bg-primary text-white font-bold px-8 py-4 rounded-full text-lg shadow-xl shadow-primary/25 hover:bg-primary-dark hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2"
                            >
                                Get Started Free
                ...
                <section className="py-20 px-6">
                    <div className="container mx-auto bg-gradient-to-r from-primary to-blue-600 rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col sm:flex-row justify-center gap-4">
                            <button onClick={() => setView('signup')} className="bg-white text-primary font-bold px-8 py-3 rounded-full hover:bg-gray-100 hover:scale-105 transition-all shadow-lg">
                                Start Learning Now
                            </button>
